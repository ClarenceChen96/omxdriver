...
class ExampleConsumer(object):
    ...
    def __init__(self, dict):
        ...
        self.QUEUE = self.MAC_Address + '-queue'
        self.EXCHANGE = "qutou.osp-exchange"
...
class ReconnectingExampleConsumer(object):
    ...
    def __init__(self, dict):
        ...
        self.dict = dict
        self._consumer = ExampleConsumer(self.dict)
...
def main():
    ...
    consumer = ReconnectingExampleConsumer(dict)
    consumer.run()
